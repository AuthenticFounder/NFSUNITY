...
public class TankManager
{
    ...
    [HideInInspector]
    public Transform m_CurSpawnPoint;            //.
    [HideInInspector]
    ...
    public void Setup()
    {
        ...
        //m_CarController = m_Instance.GetComponent<CarController>();

        // Get references to the child objects.
        //m_TankRenderers = m_Health.m_TankRenderers;

        //m_Setup.currentSpawnPoint = ;
        //m_CurSpawnPoint = m_Setup.currentSpawnPoint;
        ...
        m_TankRenderers = m_Setup.m_TankRenderers;
    }
    ...
    public void Reset()
    {
        ...
        {
            m_Setup.GetComponent<Rigidbody>().position = m_SpawnPoint.position;
            m_Setup.GetComponent<Rigidbody>().rotation = m_SpawnPoint.rotation;
        }
    }
}
